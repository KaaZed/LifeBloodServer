...
SMOOTHING_WINDOW_POINTS: Final[int] = 3  # PATCH-110 античит: окно 5 последних точек для усреднения
MAX_JUMP_METERS: Final[float] = 120.0  # PATCH-110 античит: отсечение скачка >120 м
MIN_JUMP_INTERVAL_SEC: Final[int] = 5  # PATCH-110 античит: скачок проверяем в окне <10 сек
...
# Energy limits
DAILY_ENERGY_STEPS: Final[int] = 10_000  # см. Documentation/EN_WP_1_extracted.txt строки 511-513 (1 ед. энергии = 3000 шагов)
